...
public class FTLStatsTrackerTest {
...
//            systemListsPanel.setPreferredSize(new Dimension(1000, 600));
            ...
            // SUBSYSTEMS
            java.util.List<SystemListItem> subSystemList = new ArrayList<>();
            ...
            // SYSTEMS
            java.util.List<SystemListItem> systemList = new ArrayList<>();
...
//            bottomLeftPanel.add(chartPanelPie);
            ...
            java.util.List<EventListItem> events = new ArrayList<>();
...
//            });
    ...
    private static java.util.List<EventListItem> getTestEvents(){
        java.util.List<EventListItem> events = new ArrayList<>();
